    ...
    contentItem: ColumnLayout {
        ...
        Label {
            ...
            text: "Imboard uses on-screen buttons to send keyboard shortcuts and typed text to other apps.\n\n"
                  ...
                  + "For input, Imboard requests only keyboard control. It does not request screen sharing, mouse or pointer control, remote login, camera, location, or network access. The portal defines keyboard, pointer, and touchscreen as separate capabilities; Imboard requests only KEYBOARD. Optional offline transcription separately opens your microphone only while you visibly record, and keeps the audio and text on this device.\n\n"
