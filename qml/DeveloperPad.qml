...
Item {
    ...
    readonly property var pages: [
        ...
        { title: "COMBOS", controller: root, keys: [
            ...
            ["ALL","chord",["Ctrl"],"A",
             "Select all in most apps — Ctrl+A. Terminals may use it for line navigation."],
    ...
    readonly property var pickerKeys: [
        ...
        {label:"ALL", type:"chord", modifiers:["Ctrl"], key:"A",
         description:"Select all in most apps — Ctrl+A. Terminals may use it for line navigation."},
