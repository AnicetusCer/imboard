...
QtObject {
    ...
    readonly property var pages: [
        { title: "NUM", controller: root.controller, keys: [
        ...
        { title: "CODE", controller: root.controller, keys: [
            ["|","text","|"], ["\\","text","\\"], ["`","text","`"], ["~","text","~"],
            ["(","text","("], [")","text",")"], ["[","text","["], ["]","text","]"],
            ["{","text","{"], ["}","text","}"], ["<","text","<"], [">","text",">"],
            ["$","text","$"], ["#","text","#"], ["&","text","&"], [";","text",";"] ] },
        { title: "MORE", controller: root.controller, keys: [
            ["@","text","@"], ["%","text","%"], ["^","text","^"], ["*","text","*"],
            ["+","text","+"], ["-","text","-"], ["=","text","="], ["_","text","_"],
            ["'","text","'"], ["\"","text","\""], [":","text",":"], ["!","text","!"],
            ["?","text","?"], ["/","text","/"], [",","text",","], [".","text","."] ] },
        { title: "F-KEYS", controller: root.controller, keys: [
        ...
        { title: "COMBOS", controller: root.controller, keys: [
        ...
        { title: "CUSTOM", controller: root.controller, keys: [] }
    ]
